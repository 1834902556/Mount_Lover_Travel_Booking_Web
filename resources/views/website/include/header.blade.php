        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a href="{{route('login')}}"><small class="text-light"><i class="me-5"></i>Login</small></a>
                    <a href="{{route('register')}}"><small class="text-light"><i class="me-2"></i>Register</small></a>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="" class="btn btn-danger rounded-pill py-2 px-4">Register</a>
            </div>
        </nav>
