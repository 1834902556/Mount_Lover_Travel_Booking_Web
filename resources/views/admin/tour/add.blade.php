...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add Tour</h4>
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" method="post" action="{{route('create.tour')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="title" placeholder="Tour Title">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="category" placeholder="Tour Category">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="person" name="person" placeholder="Total Person">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="duration" name="duration" placeholder="Tour Duration">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="total_cost" placeholder="Tour Cost">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="description" name="sort_description" placeholder="Sort Description">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <textarea pe="text" rows="10" class="form-control" id="description" name="long_description" placeholder="Long Description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
