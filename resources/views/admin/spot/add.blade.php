...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Add Spot</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" method="post" action="{{route('create.spot')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Spot Name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <textarea pe="text" rows="10" class="form-control" id="description" name="description" placeholder="Spot Description"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
